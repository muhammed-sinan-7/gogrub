        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Your favorite food delivered fresh and fast. From quick bites to full meals, 
              we bring the best flavors right to your doorstep.
            </p>
              ...
              {[
                ...
                <li key={link.name}>
                  <button
                    ...
                    className="text-gray-300 hover:text-orange-500 transition-colors flex items-center group text-sm"
                  >
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">
                    123 Food Street, Delicious District,<br />
                    Taste City, TC 12345
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-gray-300 text-sm">
                  ...
                  <p className="text-orange-400 font-medium">Always Open for You!</p>
                </div>
              </div>
            </div>
          </div>
